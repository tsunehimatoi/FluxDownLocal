...
class _SettingsContentState extends State<_SettingsContent> {
  ...
  Widget _buildBody(SettingsCategory category, String tabId) {
    ...
    return switch (category) {
      ...
      SettingsCategory.download => Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          _DownloadContent(
            settingsProvider: settingsProvider,
...
class _ComponentsContentState extends State<_ComponentsContent> {
  ...
  String _title(S s) => s.componentsFfmpegTitle;
  String _desc(S s) => s.componentsFfmpegDesc;
          ...
          children: [
            Expanded(
              child: ShadInput(
                ...
                placeholder: Text(s.componentsManualPathHintFfmpeg),
        ...
        Text(
          total > 0
              ? '${(fraction! * 100).toStringAsFixed(1)}%  '
                    '${DownloadTask.formatBytes(downloaded)} / ${DownloadTask.formatBytes(total)}'
              : '${DownloadTask.formatBytes(downloaded)} · ${s.componentsInstallUnknownSize}',
          style: TextStyle(fontSize: 11, color: c.textMuted),
        ),
      ],
    );
